    ...
    public class ram22{
        ...
        public static void main(String[] args) {
            ...
            while (choix != 21) {
                ...
                switch (choix) {
                    ...
                    case 1:
                        ...
                        try {
                            ...
                            PreparedStatement insertClient = connection.prepareStatement("INSERT INTO Client(telephone, nom, prenom) VALUES (?, ?, ?)");
                ...
                case 2:
                    ...
                    try {
                        // connexion à la base de données
                        Connection connection = DriverManager.getConnection(url, user, password);
                        PreparedStatement insertReservation = connection.prepareStatement("INSERT INTO Reservation(numero, dateReservation, etat, paiement) VALUES (?, ?, ?, ?)");
                ...
                case 3:  //gestionnaire
                    ...
                    try {
                        // connexion à la base de données
                        Connection connection = DriverManager.getConnection(url, user, password);
                        PreparedStatement insertGestionnaire = connection.prepareStatement("INSERT INTO Gestionnaire(telephone, nom, prenom) VALUES (?, ?, ?)");
                ...
                case 4:           //vol
                    try {
                        // connexion à la base de données
                        Connection connection = DriverManager.getConnection(url, user, password);
                        PreparedStatement insertVol = connection.prepareStatement("INSERT INTO Vol(numero, dateDepart, dateArrive, heureDepart ,heureArrive ,etat) VALUES (?, ?, ?, ?, ?, ?)");
                   ...
                   case 5: //avion
                       try {
                           ...
                           PreparedStatement insertAvion = connection.prepareStatement("INSERT INTO Avion(identifiant, type) VALUES (?, ?)");
                ...
                case 6: //administrateur
                    try {
                            ...
                            PreparedStatement insertAdministrateur = connection.prepareStatement("INSERT INTO Administrateur(telephone, nom, prenom) VALUES (?, ?, ?)");
                ...
                case 7:  //compte
                    try {
                        Connection connection = DriverManager.getConnection(url, user, password);
                        PreparedStatement insertCompte = connection.prepareStatement("INSERT INTO Compte(code, proprietaire, nombreComptes) VALUES (?, ?, ?)");
                ...
                case 8:  //client
                    ...
                    PreparedStatement deleteClient = connection.prepareStatement("DELETE FROM Client WHERE telephone = ?");
            ...
            case 9:  //reservation
                    ...
                    // suppression dans la table championnat_echecs
                    PreparedStatement deleteReservation = connection.prepareStatement("DELETE FROM Reservation WHERE numero = ?");
            ...
            case 10:  //gestionnaire
                        try{
                            ...
                            PreparedStatement deleteGestionnaire = connection.prepareStatement("DELETE FROM Gestionnaire WHERE telephone = ?");
            ...
            case 12:  //avion
                        try{
                            ...
                            PreparedStatement deleteAvion = connection.prepareStatement("DELETE FROM Avion WHERE identifiant = ?");
            ...
            case 13:  //administrateur
                try{
                        ...
                        PreparedStatement deleteAdministrateur = connection.prepareStatement("DELETE FROM Administrateur WHERE telephone = ?");
            ...
            case 14:  //compte
                        try{
                            ...
                            PreparedStatement deleteCompte = connection.prepareStatement("DELETE FROM Compte WHERE code = ?");
                ...
                case 15: //CLIENT
                    try {
                        ...
                        while (resultSet.next()) {
                            ...
                            System.out.println("+---------------+---------------+-------------------+-------------------+------------------------+");
                            System.out.println("\t\t"+resultSet.getInt("telephone") + "\t\t|\t\t\t" + resultSet.getString("nom") + "|\t\t" + resultSet.getString("prenom") + "            |");
                            System.out.println("+---------------+---------------+-------------------+-------------------+------------------------+");
                ...
                case 16: //reservation
                        try {
                            ...
                            while (resultSet.next()) {
                                System.out.println("+---------------+---------------+-------------------+-------------------+------------------------+");
                                System.out.println("numero_reservation| date_de_reservation\t| etat_reservation\t| paiement_reservation  |");
                                System.out.println("+---------------+---------------+-------------------+-------------------+------------------------+");
                                System.out.println("\t\t"+resultSet.getString("numero") + "\t\t|\t\t\t" + resultSet.getDate("dateReservation") + "|\t\t" + resultSet.getString("etat") + "|\t\t" + resultSet.getString("paiement")+       "           |");
                                System.out.println("+---------------+---------------+-------------------+-------------------+------------------------+");
...
//                        // connexion à la base de données
//                        Connection connection = DriverManager.getConnection(url, user, password);
//                        // requête SELECT pour afficher toutes les valeurs de la table championnat_echecs
...
//                            System.out.println("+------------+---------------+-----------------+-------------------------+----------------------+");
//                            System.out.println("numero_partie| etat_partie\t | id_championnat  | numero_joueur_blanc\t | numero_joueur_noir   |");
//                            System.out.println("+------------+---------------+-----------------+-------------------------+----------------------+");
//                            System.out.println("\t\t"+resultSet.getInt("numero") + "\t |\t" + resultSet.getBoolean("est_fini") + "\t     |\t\t" + resultSet.getInt("id_championnat2") + "\t\t   |   \t\t" + resultSet.getInt("joueur_blanc") + "\t\t\t\t |\t\t\t" + resultSet.getInt("joueur_noir")+       "           |");
//                            System.out.println("+------------+---------------+-----------------+-------------------------+----------------------+");
//
//                        }
//                        System.out.println();
